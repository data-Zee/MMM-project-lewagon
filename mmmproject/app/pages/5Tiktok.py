...
st.subheader('Tiktok Visualisations', divider='green')
...
fig2.add_trace(go.Scatter(x=df_monthly.index,y=df_monthly['tt_clicks'],name='Clicks',marker={'color':'#069AF3'}), secondary_y=False)
fig2.add_trace(go.Scatter(x=df_monthly.index,y=df_monthly['tt_impressions'], name='Impressions',marker={'color':'#008000'}), secondary_y=True)
fig2.add_trace(go.Scatter(x=df_monthly.index,y=df_monthly['tt_costs'],name='Costs',marker={'color':'#FF7F50'}), secondary_y=False)
# Set x-axis title
