...
fig1.add_trace(go.Scatter(x=df["google_impressions"],y=df["google_cpm"],mode='markers'),row=1,col=1)
fig1.update_xaxes(title_text="Impressions",row=1,col=1)
fig1.update_yaxes(title_text="Click Per Impressions",row=1,col=1)
fig1.add_trace(go.Scatter(x=df["google_clicks"],y=df["google_cpc"],mode='markers'),row=1,col=2)
...
fig2.add_trace(go.Scatter(x=df_monthly.index,y=df_monthly['google_clicks'],name='Clicks'), secondary_y=False)
fig2.add_trace(go.Scatter(x=df_monthly.index,y=df_monthly['google_impressions'], name='Impressions'), secondary_y=True)
fig2.add_trace(go.Scatter(x=df_monthly.index,y=df_monthly['google_costs'],name='Costs'), secondary_y=False)
# Set x-axis title
